...
1. Run `docker compose up` to start the KurrentDB instance and the frontend application. (If you are on an ARM machine (Apple Silicon) you may need to change the kurrentdb image in the [docker-compose](./docker-compose.yaml) file)
...
The workshop tasks are located in the `docs` directory and split in multiple parts. Start with [part 1](./docs/part1.md) and follow the instructions in the files.
